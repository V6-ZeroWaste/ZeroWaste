    ...
    <div class="detail-container">
        <div class="detail-header">
            ...
            <div class="detail-info">
                <p style="font-size: 20px;"><fmt:formatDate value="${vo.regist_date}" pattern="yyyy-MM-dd"/></p>
                ...
                <div class="detail-footer">
                    ...
                    <div class="buttons">
                        <form action="/user/review/update" method="post" style="display:inline;">
                            <input type="hidden" name="review_no" value="${vo.review_no}">
                            <button type="submit" class="btn btn-primary">수정</button>
                        </form>
                        <form action="/user/review/delete" method="post" style="display:inline;">
                            <input type="hidden" name="review_no" value="${vo.review_no}">
